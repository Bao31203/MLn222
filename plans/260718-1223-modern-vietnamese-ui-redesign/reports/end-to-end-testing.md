...
| `node --test --test-concurrency=1 tests/game/*.test.cjs` | PASS - 133/133, 16.61s |
| `python -m unittest -v test_pipeline.py` | PASS - 35/35, 35.63s |
...
- Build 1 SHA-256: `34FF996E78B151F39B3DAB84D77303C854200A107E154C877505C4F63D74FADB`
- Build 2 SHA-256: `34FF996E78B151F39B3DAB84D77303C854200A107E154C877505C4F63D74FADB`
- Kích thước: `1.737.687` bytes, dưới budget xấp xỉ 2 MB.
...
| Map liền khối 1440x900 / 390x844 | PASS | [desktop](./map-contiguous-1440x900.png), [mobile](./map-contiguous-390x844.png) |
...
- Map: 34 keyboard target và 44 source groups trong toàn bộ source `viewBox 0 0 3129.7 4901.01`; đất liền liền khối, đảo ở vị trí địa lý gốc, viền đồng 3 SVG unit không dùng `non-scaling-stroke`, nền trống đồng WebP nội tuyến. Mặc định 110%, zoom 100-300%, Fit/Focus, nút, con lăn theo con trỏ, phím `+/-/0`, kéo, pinch, tooltip và Enter selection pass.
...
- Offline: 0 HTTP(S) resource, 504 câu, 32 icon symbol, 34 target và texture WebP `data:` URI vẫn hoạt động.
...
- Final artifact smoke: offline reload pass với 504 câu, 32 icon, 44 nhóm SVG, 34 keyboard target, đảo nội tuyến và 0 horizontal overflow.
